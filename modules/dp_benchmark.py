...
class DifferentialPrivacyBenchmark:
    ...
    def plot_metrics(self, save_img_path=None):
        """
        Plots Accuracy, Precision, Recall, F1 vs Epsilon for each Model,
        placing the non-private baseline as a dashed line of the same color.
        """
        ...
        fig, axs = plt.subplots(rows, cols, figsize=(10, 6))  # Uniform figsize
        ...
        for i, metric in enumerate(metrics):
            ...
            for j, model in enumerate(models):
                ...
                # Collect legend handles uniquely
    ...
    def plot_metrics_acc_f1(self, save_img_path=None):
        """
        Function to plot Accuracy and F1 Score vs Epsilon for each model.
        """
        df = self.get_results_dataframe()
